    ...
    return (
        <>
            <div className="navbar w-full flex justify-between p-4 items-center fixed z-10 bg-black shadow-sm shadow-black">
                <div className="text-2xl font-bold lowercase"><Link href='/'>WatchList</Link></div>
            ...
            ${showFullScreen ? "" : "hidden"}`}>
                ...
                <div className="hidden searchWrapper flex relative w-full bg-white rounded-md my-2">
